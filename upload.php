...
$uploadDir = dirname( dirname( dirname(__FILE__) ) );//取 wp-content/uploads
$uploadDir = $uploadDir .'/uploads/'.$timeDir;

$curDomain = "http://".$_SERVER["HTTP_HOST"]."/";
//相对路径 http://www.ncmem.com/upload/2012-1-10/
$relatPath = $curDomain ."wordpress/wp-content/uploads/" . $timeDir . "/";
